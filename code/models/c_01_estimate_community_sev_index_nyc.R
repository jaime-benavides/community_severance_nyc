# script aim: estimate community severance index for NYC
...
with_progress(expr = {
  rrmc_results <- vanilla_search(
    ...
    perc_test = perc_test,
    runs = runs,
    save_as = paste0(generated.data.folder, "rrmc_vanilla_results_community_severance_nyc")
  )
})
# # read results
rrmc_results <- readRDS(paste0(generated.data.folder,"rrmc_vanilla_results_community_severance_nyc", ".rds"))
# # 
# # # 
...
saveRDS(dat_scores, paste0(generated.data.folder, "comm_sev_fa_scores_nyc_dta_us.rds"))
